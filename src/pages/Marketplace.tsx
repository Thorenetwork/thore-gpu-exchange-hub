...
const Marketplace = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary/10 via-purple-50 to-blue-50 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Discover and purchase GPU credits from verified providers worldwide. 
              Find the perfect computing power for your AI and blockchain projects.
            </p>
          </div>
